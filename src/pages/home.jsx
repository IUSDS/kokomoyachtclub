...
const benefitsData = [
    {
        ...
        description: "Our extensive approval process limits member numbers, which maximizes your ability to book what you want, when you want."
    },
    {
        title: "Best In Class Fleet",
        description: "Optimize every experience on the water. Have full access to our constantly expanding fleet, including the custom Club Yachts, designed and built for KYC."
    },
    {
        title: "5 Star Staff",
        description: "Our Captains and mates are the best in the business to provide a worry-free day on the water."
    },
    {
        title: "Flexible Memberships",
        description: "Kokomo Yacht Club offers multiple tiers of membership, allowing you to choose a membership level that best suits your lifestyle."
    }
];
        ...
        <div className='space-y-10 md:space-y-16 font-jakarta'>
            ...
            >
                ...
                >
                    ...
                    <img src={home2} alt="" className="xl:w-[300px] lg:w-[250px] md:w-[200px] w-[180px] absolute right-[10%] md:right-[2%] lg:right-[2%] lg:bottom-[10%] bottom-[5%]" />
                </motion.div>
                ...
                >
                    <p className="font-normal text-midnightblue text-3xl md:text-4xl lg:text-5xl">The Best of All Worlds</p>
                    <div className="flex justify-start">
                        <div className="hidden md:block w-2 rounded-full mr-2 bg-blue-500"></div>
                        <p className="font-veryLight">Don't own one boat when you can have access to a fleet of boats - for less money and absolutely no headaches!</p>
                    </div>
                    <p className="font-medium">
                        Our fleet ranges from runabouts and dayboats to yachts and sailing catamarans. Our fleet is meticulously maintained, fully captained, provisioned, and prepared for your adventure. Simply step aboard, relax, and indulge in your day on the water—leave the captaining, maintenance, repairs, and cleaning to our attentive staff.
                    </p>
                    ...
                    >
                        {benefitsData.map((benefit, index) => (
                            ...
                            >
                                ...
                                <h3 className="text-white text-xl font-veryLight">{benefit.title}</h3>
                                <p className="text-gray-400 text-center max-w-sm">{benefit.description}</p>
                            </motion.div>
                        ))}
                    </motion.div>
                </div>
            ...
            >
                ...
                <div className="z-10 flex flex-col text-white items-start gap-4 md:w-1/2 lg:w-1/3">
                    ...
                    <p className="text-sm lg:text-lg font-veryLight">Love boating again! Gone are the days of spending hours opening and closing your boat and managing all the maintenance and unexpected costs. View our membership options and get in touch to get started.</p>
                    <Link to={'/members'} >
