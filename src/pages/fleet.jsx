...
const FleetSection = ({ title, points, id, description, images, buttonText, reverse }) => (
    <motion.div
        id={id}
        className={`flex flex-col ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'} w-full xl:px-32 md:py-16 xl:py-24 p-8 gap-8`}
        initial="hidden"
        whileInView="visible"
            ...
            >
                ...
                <div className="absolute xl:w-2/3 inset-0 flex flex-col items-start lg:px-48 md:px-32 px-12 justify-center text-left text-white z-30">
                    ...
                    <p className="text-sm font-normal md:text-xl mb-6">
                        Take a look at the stunning boats we have available for our members to
                        book. As membership grows, we continue to add new vessels to ensure our
                        members have ample opportunities and options for booking.
                    </p>
                    <Link to={'/members'}>
