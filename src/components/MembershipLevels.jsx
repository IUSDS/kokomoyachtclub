...
const MembershipLevels = () => {
  ...
  return (
    <div className="bg-gray-100 space-y-8 py-20 px-6 md:px-16 flex flex-col items-center">
      <p className="text-midnightblue text-4xl text-center font-medium">
        Membership Levels
      </p>
      <p className="text-left md:text-center">
        Membership has its privileges. The higher the tier, the higher the
        privileges. Membership components of Mariner Points, the number of open
        reservations allowed in the system and the flexibility of booking
        outings on weekdays, weekends and multi days. All Yachting Memberships
        begin with a one-time capital contribution then simply choose which
        membership suits you best. Membership is an annual commitment, paid
        ...
        <div className="w-full p-2 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 justify-center items-center gap-4 md:flex-row">
          {membershipData.map((tier, index) => (
            ...
            >
              ...
              <p
                className={`${tier.textColor} text-xl text-center font-normal`}
              >
                {tier.title}
              </p>
              <p
                className={`${tier.textColor} text-md text-center font-normal`}
              >
                {tier.description}
              </p>
      ...
      <div className="text-left md:text-center">
        <p>
          See detailed membership overview for specific terms and conditions
          regarding rules by membership tier. Higher tiers have greater
          flexibility. Reservations may have restrictions based on day of week,
          time of year and number of open reservations. Vessel, staff, fuel for
          coastal cruising, water toys, insurance and core provisioning included
          in membership. Additional provisioning of catering and adult
          beverages, $85 booking fee, excess fuel and optional staff gratuity
          not included. Kokomo Yacht Club is a private luxury boat membership
          club. All potential members must be approved for membership by Kokomo
          Yacht Club.
        </p>
      </div>
      ...
      <button
        ...
        className="px-6 py-3 font-semibold text-sm md:text-base bg-midnightblue hover:bg-midnightblue text-white hover:scale-105 rounded-full transform duration-300 shadow-lg"
      >
