...
const MembershipLevels = () => {
    ...
    return (
        <div className="bg-gray-100 space-y-8 py-20 px-6 md:px-16">
            ...
            <div className="w-full px-2 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 justify-center items-center gap-4 md:flex-row">
                {membershipData.map((tier, index) => (
                    ...
                    >
                        ...
                        <p className={`${tier.textColor} text-xl text-center font-normal`}>{tier.title}</p>
                        <p className={`${tier.textColor} text-md text-center font-normal`}>{tier.description}</p>

                        {/* Points and Benefits */}
                        <div className="flex flex-col space-y-2">
                            <div className="flex flex-col pl-2 text-sm justify-start">
                                <div className={`flex items-center gap-2 border-b border-dashed ${tier.borderColor} pb-2`}>
                        ...
                        {/* Button */}
                        <p className={`text-3xl pt-6 ${tier.textColor} font-medium`}>Inquire for Details</p>
